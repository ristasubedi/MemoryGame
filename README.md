...
**Memory Game** is an immersive memory game that transports players into the heart of a wild safari. Designed with a vibrant jungle aesthetic, the app challenges  brain to find and match pairs of animals.
...
([https://www.loom.com/share/1d792e09359d4dfba6c66bc0dd82607b]) .

## Notes

The biggest logic challenge was timing. If a card vanishes the instant it is touched, the player doesn't get to see what the second card was.

## License

    Copyright [2026] [Rista Subedi]
